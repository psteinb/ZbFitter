...
for item in $ITEMS;do
    NEWFILE80=bundleIP3DSV1_80_allJets_sumSV12mass_${item}.cfg 
    NEWFILE70=bundleIP3DSV1_70_allJets_sumSV12mass_${item}.cfg 
    cp bundleIP3DSV1_80_allJets_sumSV12mass_template.cfg ${NEWFILE80}
    cp bundleIP3DSV1_70_allJets_sumSV12mass_template.cfg ${NEWFILE70}
