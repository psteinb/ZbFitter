...
#python $SRC/python/bundleHistos.py -f `pwd`/bundleIP3DSV1_70_NJetsGe2_SV12mass.cfg -o SherpaIP3DSV1_70_NJetsGe2_SV12mass.root
#python $SRC/python/bundleHistos.py -f `pwd`/bundleIP3DSV1_80_NJetsGe2_SV12mass.cfg -o SherpaIP3DSV1_80_NJetsGe2_SV12mass.root
