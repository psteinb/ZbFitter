#ifndef _CONFPSEUDOEXPERIMENT_H_
#define _CONFPSEUDOEXPERIMENT_H_

#include <string>

class ConfPseudoExperiment {
...
ConfPseudoExperiment::ConfPseudoExperiment(int inArgc, char** inArgv):
...
void ConfPseudoExperiment::parse(){
...
void ConfPseudoExperiment::printHelp(){
...
void ConfPseudoExperiment::printConf(){
...
void ConfPseudoExperiment::setOpt(int inArgc, char** inArgv){
