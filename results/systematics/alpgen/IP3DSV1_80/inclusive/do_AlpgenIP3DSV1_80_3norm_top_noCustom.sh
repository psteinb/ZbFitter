...
#	RunFitter.exe -M Migrad -d $SRC/bundles/alpgen/inclusive/systematics/IP3DSV1_80/bundleIP3DSV1_80_allJets_sumSV12mass_${file}.root -c ${ENVFILE} -D "Data" -T "TrueB_varied,TrueC_varied,TrueL_varied,Top_varied" -o InclusiveData_${ENVFILE/.env/} -r 5 > `pwd`/${ENVFILE/.env/.log} 2>&1 &
	...
	RunFitter.exe -M Migrad -d $SRC/bundles/alpgen/inclusive/systematics/IP3DSV1_80/bundleIP3DSV1_80_allJets_sumSV12mass_${file}.root -c ${ENVFILE/top/background} -D "PseudoData" -T "TrueB_varied,TrueC_varied,TrueL_varied,Background_varied" -o $BACKFILE -r 5 > `pwd`/$BACKFILE.log 2>&1 &
