...
#UCL
RunFitter.exe -M Migrad -d $SRC/AlpgenZmumuJetVertexMassByFlav.root  -c /amnt/remote/pkthafc.home/psteinb/development/sandbox/fitter/results/central/BinnedEML.2params.env -D "Data" -T "MC_Signal_B,MC_Signal_CpL" -o UCL.2params -r 10 -m 1 -P UCL.10k_mumu_MeansSigmasPullsMaxLLH.root > $SRC/results/central/fit.Alpgen.log 2>&1 &
