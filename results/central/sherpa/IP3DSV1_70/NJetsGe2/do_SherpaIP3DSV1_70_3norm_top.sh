...
RunFitter.exe -M Migrad -d $SRC/bundles/sherpa/NJetsGe2/SherpaIP3DSV1_70_NJetsGe2_sumSV12mass.root  -c SherpaIP3DSV1_70_2norm_fixedLight_fixedTop_maxSV1mass.env -D "Data" -T "smoothedTrueB,smoothedTrueC,smoothedTrueL,smoothedTop" -o Sherpa_2norm_fixedLight_fixedTop_NJetsGe2_maxSV1mass_smoothed -r 5   > $SRC/results/central/sherpa/IP3DSV1_70/NJetsGe2/SherpaIP3DSV1_70_2norm_fixedLight_fixedTop_maxSV1mass_lowc_HIGHb_smoothed.log 2>&1 &
...
RunFitter.exe -M Migrad -d $SRC/bundles/sherpa/NJetsGe2/SherpaIP3DSV1_70_NJetsGe2_sumSV12mass.root  -c SherpaIP3DSV1_70_2norm_fixedLight_fixedTop_sumSV1mass.env -D "Data" -T "smoothedTrueB,smoothedTrueC,smoothedTrueL,smoothedTop" -o Sherpa_2norm_fixedLight_fixedTop_NJetsGe2_sumSV1mass_smoothed -r 5   > $SRC/results/central/sherpa/IP3DSV1_70/NJetsGe2/SherpaIP3DSV1_70_2norm_fixedLight_fixedTop_sumSV1mass_smoothed.log 2>&1 &