CNT=0
TOTALCNT=`find $SRC/bundles/sherpa/inclusive/systematics/uncorrelated/ -name "*root"|wc -l`
for file in $SRC/bundles/sherpa/inclusive/systematics/uncorrelated/*root;do
    CNT=$((CNT + 1 ))
