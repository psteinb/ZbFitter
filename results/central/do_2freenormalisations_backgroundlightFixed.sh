...
#
RunFitter.exe -M Migrad -d $SRC/ZeeSherpa_allBackgrounds.root  -c $SRC/results/environments/SherpaAdded/BinnedEML.2p2params.Sherpa_ee_allBackgrounds.env -D "Data" -T "Zjets_b,Zjets_c,Zjets_l,Background" -o Sherpa_2p2Normalisations_ee_allBackgrounds_paper -r 5 -m 6  
