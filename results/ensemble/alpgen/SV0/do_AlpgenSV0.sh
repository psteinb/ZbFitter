...
RunPseudoExperiments.exe -M Migrad -d $SRC/bundles/alpgen/inclusive/customSV0_allJets_sumSV0mass.root  -c AlpgenSV0_3free_background_sumSV0mass_custom.env -D "Data" -T "TrueB,TrueC,TrueL,Background" -o AlpgenSV0_3free_background_x200 -r 5 -i 10000 -P 200  > $SRC/results/central/AlpgenSV0_3free_background_x200.log 2>&1 &
