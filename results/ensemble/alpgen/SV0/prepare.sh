...
cp AlpgenSV0_3norm_background_sumSV0mass_custom.env AlpgenSV0_3free_background_sumSV0mass_custom.env
sed -i -e '/low/s/^/#/g' AlpgenSV0_3free_background_sumSV0mass_custom.env