...
RunPseudoExperiments.exe -M Migrad -d $SRC/bundles/sherpa/inclusive/customSV0_allJets_sumSV0mass.root  -c SherpaSV0_3norm_background_sumSV0mass_custom.env -D "Data" -T "TrueB,TrueC,TrueL,Background" -o SherpaSV0_3norm_background_x200 -r 5 -i 15000 -P 200  > $SRC/results/central/SherpaSV0_3norm_background_x200.log 2>&1 &
...
RunPseudoExperiments.exe -M Migrad -d $SRC/bundles/sherpa/inclusive/customSV0_allJets_sumSV0mass.root  -c SherpaSV0_3free_background_sumSV0mass_custom.env -D "Data" -T "TrueB,TrueC,TrueL,Background" -o SherpaSV0_3free_background_x200 -r 5 -i 15000 -P 200  > $SRC/results/central/SherpaSV0_3free_background_x200.log 2>&1 &
