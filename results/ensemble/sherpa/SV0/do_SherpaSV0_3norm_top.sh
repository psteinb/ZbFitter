RunPseudoExperiments.exe -M Migrad -d $SRC/bundles/sherpa/SherpaSV0.root  -c SherpaSV0_3norm_top.env -D "Data" -T "TrueB,TrueC,TrueL,Top" -o SherpaSV0_3norm_top -r 5 -i 15000  > $SRC/results/central/SherpaSV0_3norm_top.log 2>&1 &
